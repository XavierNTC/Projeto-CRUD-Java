...
public class ProdutosView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabelSubTitulo.setText("Gerenciar Produtos");
        ...
        jTextAreaProdutos.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(173, 212, 156)));
        jScrollPane2.setViewportView(jTextAreaProdutos);
    ...
    private void jButtonAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAtualizarActionPerformed
        ProdutosAtualizarView segundaTela = new ProdutosAtualizarView(); // Substitua "SegundaTela" pelo nome da sua classe da segunda tela
    ...
    private void jButtonApresentarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonApresentarActionPerformed
        ...
        jTextAreaProdutos.setFont(new Font("Monospaced", Font.PLAIN, 12));

        jTextAreaProdutos.setText(""); 

        ProdutoPersistencia obj_ProdutoPersistencia = new ProdutoPersistencia(); 

        List<ProdutoModel> produtos = obj_ProdutoPersistencia.listarProdutos(); 

        jTextAreaProdutos.append(
            String.format("%-5s %-20s %-25s %-10s\n", "ID", "Descrição", "Valor Unitário", "Estoque")
        );
    ...
    private void jButtonCriarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCriarActionPerformed
        ProdutosInserirView segundaTela = new ProdutosInserirView(); // Substitua "SegundaTela" pelo nome da sua classe da segunda tela
        segundaTela.setVisible(true);
        dispose();
